import type { KeyData } from '@lottery-network/api';
import {
  usePrefs,
...
import { LotteryBlack, Coins } from '@lottery-network/icons';
        ...
        {isLoadingPublicKeys ? (
          ...
          <>
            ...
            <Flex alignItems="center" flexDirection="column">
              ...
              >
                <Trans>Create a new wallet key to get started with Lottery.</Trans>
              </Typography>
              <Button
