import { Daemon, optionsForPlotter, defaultsForPlotter, PlotterName } from '@lottery-network/api';
import type { Plotter, PlotterMap, PlotterApi } from '@lottery-network/api';
