import { Connection, ServiceConnectionName } from '@lottery-network/api';
import { useGetWalletConnectionsQuery } from '@lottery-network/api-react';
import { Card, FormatBytes, Loading, Table } from '@lottery-network/core';
