...
import type { NFTRecoverInfo } from '@lottery-network/api';
import {
  useLocalStorage,
...
export default function NFTRecover(props: NFTRecoverProps) {
  ...
  async function handleSubmit() {
    ...
    setContent(`${t1  }: ${  mojoToLottery(response.amount)  } ${  currencyCode}, ${t2  }: ${t3
        ...
        <Grid spacing={2} alignItems="stretch" container>
          ...
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToLotteryLocaleString(nftData.totalAmount, locale):"-"}
            />
          </Grid>
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToLotteryLocaleString(nftData.balanceAmount, locale):"-"}
            />
          </Grid>
          <Grid xs={12} md={4} item>
            <CardSimple
              ...
              value={nftData?mojoToLotteryLocaleString(nftData.recordAmount, locale):"-"}
            />
          </Grid>
        </Grid>
        </Form>
