import { WalletType, type Wallet } from '@lottery-network/api';
import { useGetCatListQuery } from '@lottery-network/api-react';
import { Flex, TooltipIcon, useCurrencyCode } from '@lottery-network/core';
import { CrCat } from '@lottery-network/icons';
