import { TransactionType } from '@lottery-network/api';
import type { Transaction } from '@lottery-network/api';
import { useGetAutoClaimQuery, useGetTimestampForHeightQuery, useGetHeightInfoQuery } from '@lottery-network/api-react';
