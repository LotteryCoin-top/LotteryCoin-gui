import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@lottery-network/api-react';
import { Color, Flex, Loading, truncateValue, useColorModeValue } from '@lottery-network/core';
import { Reload } from '@lottery-network/icons';
