import type { CATToken } from '@lottery-network/api';
import { SyncingStatus } from '@lottery-network/api';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@lottery-network/api-react';
import { Back, Flex, Loading, useShowError } from '@lottery-network/core';
