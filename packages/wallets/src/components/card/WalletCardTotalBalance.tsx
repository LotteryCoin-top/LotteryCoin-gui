import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@lottery-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@lottery-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for LOT, CATs, or
