...
import { NFTInfo } from '@lottery-network/api';
...
import AppIcon from '../assets/img/lottery64x64.png';
import About from '../components/about/About';
import { i18n } from '../config/locales';
import lotteryEnvironment, { lotteryInit } from '../util/lotteryEnvironment';
...
// At that time, the config file is created here by `lottery init`.
if (!checkConfigFileExists()) {
  lotteryInit();
}

// Set the userData directory to its location within LOTTERY_ROOT/gui
setUserDataDir();
...
const ensureCorrectEnvironment = () => {
  ...
  if (!lotteryEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
    app.quit();
    return false;
  }
...
if (ensureSingleInstance() && ensureCorrectEnvironment()) {
  ...
  const createWindow = async () => {
    if (manageDaemonLifetime(NET)) {
      lotteryEnvironment.startLotteryDaemon();
    }
...
function getMenuTemplate() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'LotteryCoin Wiki' }),
          click: () => {
            openExternal('https://github.com/LotteryCoin-top/LotteryCoin/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/LotteryCoin-top/LotteryCoin/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/LotteryCoin-top/LotteryCoin/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/LotteryCoin-top/LotteryCoin/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/LotteryCoin-top/LotteryCoin/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/lottery');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
          click: () => {
            openExternal('https://twitter.com/lottery_project');
          },
        },
      ],
    },
  ...
  if (process.platform === 'darwin') {
    // LotteryCoin menu (Mac)
    template.unshift({
      label: i18n._(/* i18n */ { id: 'LotteryCoin' }),
      submenu: [
        {
          label: i18n._(/* i18n */ { id: 'About LotteryCoin' }),
          click: () => {
            openAbout();
          },
        },
