import { useGetNewFarmingInfoQuery } from '@lottery-network/api-react';
import { Link, Table, Card } from '@lottery-network/core';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/LotteryCoin-top/LotteryCoin/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
