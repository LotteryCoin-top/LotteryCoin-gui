import type { Connection } from '@lottery-network/api';
import { ServiceName } from '@lottery-network/api';
import { useGetFarmerFullNodeConnectionsQuery } from '@lottery-network/api-react';
import { Table, Card, FormatBytes, FormatConnectionStatus } from '@lottery-network/core';
