...
import { Flex, Link, StateIndicator, State, Tooltip, useCurrencyCode } from '@lottery-network/core';
      ...
      <Box>
        ...
        <p>
          ...
          <StyledTableForTooltip>
            ...
            <tr>
              <Link target="_blank" href="https://docs.lotterycoin.top/faq/#why-does-my-lottery-farm-say-missing-signage-points">
