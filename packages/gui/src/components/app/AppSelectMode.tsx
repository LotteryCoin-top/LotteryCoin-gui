import { Button, Color, Flex, Logo, Card, useMode, Mode } from '@lottery-network/core';
import { Farming as FarmingIcon } from '@lottery-network/icons';
                  ...
                  <Flex flexDirection="column" gap={1.5} flexGrow={1}>
                    <Flex gap={1} alignItems="center">
                      ...
                      <Typography variant="body2">
                        <Trans>Store and Send LOT</Trans>
                      </Typography>
                    </Flex>
                    <Flex gap={1} alignItems="center">
                      <StyledCheckIcon color="primary" />
