import { Button, Flex } from '@lottery-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Lottery application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Lottery services version: {backV}
                <br />
                Lottery application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Lottery application and stop all Lottery services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
