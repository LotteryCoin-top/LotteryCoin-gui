...
import WalletConnectProvider, { WalletConnectLotteryProjectId } from '../walletConnect/WalletConnectProvider';
                        ...
                        <AddressBookProvider>
                          <OffersProvider>
                            <NotificationsProvider>
                              <WalletConnectProvider projectId={WalletConnectLotteryProjectId}>
