...
import { useGetOfferSummaryMutation, useCheckOfferValidityMutation } from '@lottery-network/api-react';
import { isValidURL } from '@lottery-network/core';
...
const log = debug('lottery-gui:OfferProvider');
