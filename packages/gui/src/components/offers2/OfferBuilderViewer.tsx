import { OfferSummaryValidTimes } from '@lottery-network/api';
import {
  useGetWalletsQuery,
        ...
        {error ? (
          ...
          <Alert severity="error">
            <Trans>
              ...
              <Link
                target="_blank"
                href="https://docs.lotterycoin.top/getting-started/wallet-guide/#taker-attempts-to-accept-an-invalid-offer"
              >
                here
              </Link>{' '}
              to learn more.
