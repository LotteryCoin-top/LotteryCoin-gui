...
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@lottery-network/core';
import { Tokens } from '@lottery-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Lottery Asset Tokens (CATs) are tokens built on top of LOT</Trans>}
