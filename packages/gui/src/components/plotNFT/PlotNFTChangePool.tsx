import { useGetPlotNFTsQuery, usePwSelfPoolMutation, usePwJoinPoolMutation } from '@lottery-network/api-react';
import { Flex, State, Loading, StateTypography } from '@lottery-network/core';
