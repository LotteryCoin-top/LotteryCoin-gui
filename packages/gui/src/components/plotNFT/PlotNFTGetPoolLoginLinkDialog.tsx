import type { PlotNFT, PlotNFTExternal } from '@lottery-network/api';
import { useGetPoolLoginLinkQuery } from '@lottery-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@lottery-network/core';
