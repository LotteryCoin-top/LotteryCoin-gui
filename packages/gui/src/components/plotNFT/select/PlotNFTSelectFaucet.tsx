import { Button, Flex, CardStep, useCurrencyCode } from '@lottery-network/core';
...
export default function PlotNFTSelectFaucet(props: Props) {
  ...
  const handleClick = React.useCallback(() => {
    if (currencyCode === 'TLOT') {
      openExternal('https://testnet0-faucet.lotterycoin.top/');
    } else {
      openExternal('https://faucet.lotterycoin.top/');
    }
