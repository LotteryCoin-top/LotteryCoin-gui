import type { UnconfirmedPlotNFT } from '@lottery-network/api';
import { useGetTransactionQuery } from '@lottery-network/api-react';
import { Flex, Link, Loading } from '@lottery-network/core';
