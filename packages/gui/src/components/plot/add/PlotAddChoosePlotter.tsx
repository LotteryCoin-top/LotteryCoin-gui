import { defaultPlotter, PlotterName } from '@lottery-network/api';
import type { Plotter, PlotterMap } from '@lottery-network/api';
import { useGetPlottersQuery } from '@lottery-network/api-react';
import { CardStep, Select, StateColor } from '@lottery-network/core';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function getDisplayablePlotters(p: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => (a === PlotterName.LOTTERYPOS ? -1 : a.localeCompare(b)));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
          ...
          the default Lottery Proof of Space plotter. If unsure, use the default Lottery Proof of Space plotter.
        </Trans>
      </Typography>
