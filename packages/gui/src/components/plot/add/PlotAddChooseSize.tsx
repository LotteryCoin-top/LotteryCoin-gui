import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@lottery-network/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/LotteryCoin-top/LotteryCoin/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
