import { useRefreshPlotsMutation } from '@lottery-network/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@lottery-network/core';
import { Plots } from '@lottery-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              Plots are allocated space on your hard drive used to farm and earn Lottery. &nbsp;
              <Link target="_blank" href="https://github.com/LotteryCoin-top/LotteryCoin/wiki/Network-Architecture">
                Learn more
              </Link>
            </Trans>
          </Typography>
