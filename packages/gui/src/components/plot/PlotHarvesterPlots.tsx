import { type Plot } from '@lottery-network/api';
import { useGetHarvesterPlotsValidQuery, useGetHarvesterQuery } from '@lottery-network/api-react';
import { Address, TableControlled, Flex, FormatBytes, Tooltip, StateColor } from '@lottery-network/core';
