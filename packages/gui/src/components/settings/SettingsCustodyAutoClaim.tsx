import { useGetAutoClaimQuery, useSetAutoClaimMutation } from '@lottery-network/api-react';
import { Flex, SettingsText, Form, ButtonLoading, Fee, lotteryToMojo, mojoToLottery } from '@lottery-network/core';
import { ConnectCheckmark } from '@lottery-network/icons';
...
export default function SettingsCustodyAutoClaim(props) {
  ...
  const autoClaimFee = autoClaimData?.txFee ? mojoToLottery(autoClaimData.txFee).toNumber() : 0;
