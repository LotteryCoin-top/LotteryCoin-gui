...
import { useExtendDerivationIndexMutation, useGetCurrentDerivationIndexQuery } from '@lottery-network/api-react';
import { AlertDialog, ButtonLoading, Flex, Form, TextField, useOpenDialog } from '@lottery-network/core';
import { useWalletState } from '@lottery-network/wallets';
