...
import { useGetDIDQuery, useGetDIDNameQuery, useSetDIDNameMutation } from '@lottery-network/api-react';
import { Color, CopyToClipboard, Flex, Loading, Tooltip, truncateValue } from '@lottery-network/core';
