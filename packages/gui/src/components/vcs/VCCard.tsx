...
import { Truncate, Button, Color, useOpenDialog, AlertDialog, Flex, More, MenuItem } from '@lottery-network/core';
import { Burn as BurnIcon } from '@lottery-network/icons';
  ...
  async function openRevokeVCDialog(type: string) {
    ...
    if (confirmedWithFee === -1) {
      ...
      revokedResponse = await revokeVC({
        ...
        fee: parseFloat(confirmedWithFee) * 1_000_000_000,
      });
    }
