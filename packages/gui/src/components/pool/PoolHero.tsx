import { Button, CardHero } from '@lottery-network/core';
import { Pooling } from '@lottery-network/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>Smooth out your LOT farming rewards by joining a pool.</Trans>
          </Typography>
