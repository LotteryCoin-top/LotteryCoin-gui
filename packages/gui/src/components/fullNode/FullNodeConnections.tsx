import { Connection } from '@lottery-network/api';
import { useGetFullNodeConnectionsQuery } from '@lottery-network/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@lottery-network/core';
