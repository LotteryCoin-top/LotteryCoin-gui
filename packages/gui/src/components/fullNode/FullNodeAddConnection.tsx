import { useOpenFullNodeConnectionMutation } from '@lottery-network/api-react';
import { Button, ButtonLoading, DialogActions, Flex, Form, TextField, useShowError } from '@lottery-network/core';
