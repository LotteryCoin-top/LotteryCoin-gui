...
import icon from '../../assets/img/lottery_circle.svg';
...
const url = 'https://lotterycoin.top';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} Lottery Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport href="https://github.com/LotteryCoin-top/LotteryCoin/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
