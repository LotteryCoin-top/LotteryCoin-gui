import { OfferCoinOfInterest, OfferSummaryRecord } from '@lottery-network/api';
import { useGetOffersCountQuery, useGetAllOffersQuery } from '@lottery-network/api-react';
