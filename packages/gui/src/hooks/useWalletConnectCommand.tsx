import api, { store, useGetLoggedInFingerprintQuery } from '@lottery-network/api-react';
import { useOpenDialog, useAuth } from '@lottery-network/core';
...
const log = debug('lottery-gui:walletConnectCommand');
