import type { OfferSummaryRecord, Wallet } from '@lottery-network/api';
import { useTakeOfferMutation } from '@lottery-network/api-react';
import { AlertDialog, lotteryToMojo, useOpenDialog, useShowError } from '@lottery-network/core';
...
export default function useAcceptOfferHook(): [AcceptOfferHook] {
  ...
  async function acceptOffer(
    ...
    const feeInMojos: BigNumber = fee ? lotteryToMojo(fee) : new BigNumber(0);
